...
Recycler2 is written in Python3. Recycler2 uses NumPy, NetworkX, pySAM, and nose. The correct versions of these required dependencies will all be installed by the setup.py script.
